...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async() => {
    try{
      const {data} = await axios.get(`${process.env.REACT_APP_API}/api/v1/product/getProductById/${slug}`)
      ...
      if(data?.success){
        ...
        setAlreadyImage(data.product.image);
              ...
              >
                ...
                <div className="mb-3">
                  <label className="btn btn-outline-secondary col-md-12">
                    {image ? image.name : "uploaded image"}
                    <input
                      type="file"
                      name="image"
                      accept="image/*"
